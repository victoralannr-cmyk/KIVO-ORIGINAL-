...
const vec3 BASE_COLOR = vec3(25.0, 35.0, 58.0) / 255.0; // #19233A
...
void main() {
  ...
  // The background color is set on the body, so we don't need to set it here.
  // The shader canvas will blend over it.
}
`;
