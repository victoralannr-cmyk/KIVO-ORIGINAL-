    ...
    >
       {kLogo && (
          <Image
              ...
              width={500}
              height={500}
              className="absolute -top-1/4 -left-1/4 w-3/4 h-auto opacity-10 mix-blend-screen animate-orbit hidden md:block"
      ...
      {kivoText && (
          <Image
              ...
              width={600}
              height={200}
              className="absolute -bottom-1/4 -right-1/4 w-2/3 h-auto opacity-5 animate-orbit hidden md:block"
