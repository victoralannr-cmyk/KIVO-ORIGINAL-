    ...
    >
       {kLogo && (
          <Image
              ...
              width={500}
              height={500}
              className="absolute -top-10 -right-10 w-1/3 h-auto opacity-10 mix-blend-screen animate-orbit hidden md:block"
      ...
      {kivoText && (
          <Image
              ...
              width={600}
              height={200}
              className="absolute bottom-10 -left-20 w-1/2 h-auto opacity-5 animate-orbit hidden md:block"
