    ...
    >
       {kivoText && (
          <Image
              ...
              width={600}
              height={200}
              className="absolute top-1/4 left-10 w-1/3 h-auto opacity-[0.03] mix-blend-screen animate-orbit hidden md:block"
       ...
       {kLogo && (
          <Image
              ...
              width={500}
              height={500}
              className="absolute bottom-1/4 right-10 w-1/4 h-auto opacity-5 mix-blend-screen animate-orbit hidden md:block"
